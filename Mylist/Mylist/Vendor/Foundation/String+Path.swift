...
extension String {
    ...
    public func appendingPathComponent(path: String?, regularly: Bool = false) -> String {
        ...
        if let firstchar = name.characters.first, firstchar == "/" {
    ...
    public func pathRegularly() -> String {
        
        return "".pathRegularly(of: self)
    }
	...
	public func isChildWith(_ path: String) -> Bool {
